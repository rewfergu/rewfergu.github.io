const id = "photo-search.mdx";
						const collection = "work";
						const slug = "photo-search";
						...
						const data = {name:"Photo Search",status:2,priority:8,featured:true,cover:{src:"~/assets/images/projects/photo-search/cover.png",alt:"screenshot of main photo search screen with title and camera button"},tags:["python","flask","opencv"],images:[{src:"~/assets/images/projects/photo-search/img_2173.png",alt:"mobile screenshot showing home screen with title and camera button"},{src:"~/assets/images/projects/photo-search/img_2174.png",alt:"mobile screenshot showing the take picture interaction"},{src:"~/assets/images/projects/photo-search/img_2175.png",alt:"the results screen after a successful match"}],video:["https://youtu.be/zJCTS6EI4sQ"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/robertferguson/Projects/rewferguson/src/content/work/photo-search.mdx",
							rawData: undefined,
						};
